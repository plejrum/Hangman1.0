    ...
    public partial class Hangman : Form
    {
        ...
        private void startToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (flowLayoutPanel1.Enabled)
                if (MessageBox.Show("Trwa rozgrywka. Chcesz zacząć od początku?", "Trwa rozgrywka", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.Cancel)
                    return;
